  ...
  return (
    <div className="row">
      <div className="col-6 col-md-6">
        <img src={oliveoil1} alt="oil" className="card-img-top" />
      </div>
      <div className="col-6 col-md-6">
        <Title text="A passion for olive oil" />
        <h5>
          Elaioladon began with a love, a passion - perhaps even an
          obsession - with olive oil. After living-in and traveling around the
          ...
          olive oil, we realized there was a huge deficit for quality olive oil
